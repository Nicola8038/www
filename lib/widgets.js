...
class AktTrades extends AktTickerElement {
  connectedCallback() {
    ...
    table.innerHTML =
    '<thead><tr><th data-field="datetime" data-formatter="dateFormatter">Time</th><th data-field="type">Type</th><th data-field="sharesTraded">Shares Traded</th><th data-field="pricePerShare">Price</th><th data-field="note" data-formatter="insiderFormatter">Note</th></tr>';
